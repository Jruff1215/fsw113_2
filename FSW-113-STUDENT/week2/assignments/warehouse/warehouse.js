...
for (i = 0; i < parts.length; i++) {
    var detailsList = document.createElement("INPUT");
    detailsList.setAttribute("type", "checkbox");
    detailsList.innerHTML = parts[i].partNbr
    document.detailsList.appendChild(orderDetails)
}
