...
function combineLists() {
    const scav0 = document.getElementById('scavenger-0').value.split(',')
    const scav1 = document.getElementById('scavenger-1').value.split(',')
    const scav2 = document.getElementById('scavenger-2').value.split(',')
    const scav3 = document.getElementById('scavenger-3').value.split(',')
 
let scavAll = [...scav0, ...scav1, ...scav2, ...scav3].sort()

document.getElementById('AllItems').innerHTML = scavAll.join(', ')
}
